    ...
    <div className=' mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
      ...
      {/* ================= IMAGE CONTAINER =================== */}
        ...
        {resultImage && <div className=' flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
          ...
          <a href={resultImage} download className=' px-8 py-2.5 text-white text-sm cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 transition-all duration-700 hover:scale-105 rounded-full'>
            Download image
          </a>
        </div>}
      </div>
